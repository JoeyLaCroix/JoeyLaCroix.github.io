class Dog{
    ...
    get item(){
        ...
        const expCon = doucment.createElement("a");
        expCon.href="#";
...
const dogs = [];
//Dog myDoc = new Dog("molly", "pitbull", "brown", 4, "xs", "images/molly.jpg");
dogs.push(new Dog("Coco", "Morkie", "Black", 5, "small", "yorkie.jpg"));
dogs.push(new Dog("Sam", "Golden", "Yellow", 1, "med", "golden-retreiver.jpg"));
